...
export function PenguincordDonorModal() {
    openModal(props => (
        <ErrorBoundary noop onError={() => {
            props.onClose();
            VencordNative.native.openExternal("https://github.com/sponsors/thororen1234");
            ...
            >
                <div>
                    ...
                    <div style={{ padding: "1em" }}>
                        <Paragraph>
                            This Badge is a special perk for Penguincord (Not Vencord) Donors or just friends of the developers. It is a way to show support for the development of Penguincord and its plugins.
                        </Paragraph>
                        <Paragraph className={Margins.top20}>
                            Please consider supporting the development of Penguincord by becoming a donor. It would mean a lot!
                        </Paragraph>
                    </div>
                </div>
                <div>
