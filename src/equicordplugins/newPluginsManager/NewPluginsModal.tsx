            ...
            subtitle={
                <>
                    ...
                    <Notice.Info className={cl("notice")}>
                        Penguincord is Open Source Software. If you enjoy using it, consider supporting us <Link href="https://github.com/sponsors/thororen1234" target="_blank" rel="noopener noreferrer">here</Link>.
                    </Notice.Info>
                </>
            }
            actions={[
