...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        ...
        { src: "https://badge.fatpenguin.dev/donor.webp", shown: settings.store.showPenguincordDonor, title: "Penguincord donor badges", key: "PenguincordDonor", position: settings.store.PenguincordDonorPosition },
