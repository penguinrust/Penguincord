...
function PenguincordIcon() {
    return <img src="https://penguincord.org/assets/favicon.png" alt="Penguincord" style={ICON_STYLE} />;
}

function VencordIcon() {
    return <img src="https://penguincord.org/assets/icons/vencord/icon-light.png" alt="Vencord" style={ICON_STYLE} />;
}
...
const cloudBackendOptions = [
    ...
    { label: "Penguincord Cloud", value: "https://cloud.fatpenguin.dev/" },
    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom16}>
                Penguincord's cloud integration allows you to sync your settings across multiple devices and Discord installations. Your data is securely stored and can be easily restored at any time.
            </Paragraph>
            ...
            <Paragraph className={Margins.bottom16}>
                Choose which cloud backend to use for storing your settings. You can switch between Penguincord's and Vencord's cloud services, or use a self-hosted instance.
            </Paragraph>
            ...
            <div className={Margins.bottom8}>
                <SearchableSelect
                    ...
                    closeOnSelect={true}
                    renderOptionPrefix={o => o?.value?.includes("penguincord") ? <PenguincordIcon /> : <VencordIcon />}
                />
            </div>
            ...
            <Paragraph className={Margins.bottom16}>
                Synchronize your Penguincord settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.
            </Paragraph>
