...
function EquibopSection() {
    ...
    return (
        <Flex className={Margins.bottom20} flexDirection="column" gap="1em">
            <Card variant="brand">
                <HeadingSecondary>Equibop & Penguincord</HeadingSecondary>
                <Paragraph>Equibop and Penguincord are two separate things. This updater is for Penguincord.</Paragraph>
    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom20}>
                Control how Penguincord keeps itself up to date. You can choose to update automatically in the background or be notified when new updates are available.
            </Paragraph>

            <FormSwitch
                title="Automatically update"
                description="When enabled, Penguincord will automatically download and install updates in the background without asking for confirmation. You'll need to restart Discord to apply the changes."
            ...
            <FormSwitch
                ...
                description="Receive a notification when Penguincord finishes downloading an update in the background, so you know when to restart Discord."
            ...
            <Paragraph className={Margins.bottom8}>
                This is the GitHub repository where Penguincord fetches updates from.
            </Paragraph>
