...
const CHANGELOG_HISTORY_KEY = "PenguincordChangelog_History";
const LAST_SEEN_HASH_KEY = "PenguincordChangelog_LastSeenHash";
const KNOWN_PLUGINS_KEY = "PenguincordChangelog_KnownPlugins";
const KNOWN_SETTINGS_KEY = "PenguincordChangelog_KnownSettings";
const LAST_REPO_CHECK_KEY = "PenguincordChangelog_LastRepoCheck";
