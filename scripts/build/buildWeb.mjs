...
const buildConfigs = [
    ...
    },
    {
        ...
        outfile: "dist/Penguincord.user.js",
        banner: {
...
async function buildExtension(target, files) {
    const entries = {
        "dist/Penguincord.js": await readFile("dist/browser/extension.js"),
        "dist/Penguincord.css": await readFile("dist/browser/extension.css"),
...
const appendCssRuntime = readFile("dist/Penguincord.user.css", "utf-8").then(content => {
    const cssRuntime = `unsafeWindow._vcUserScriptRendererCss=\`${content.replaceAll("`", "\\`")}\``;

    return appendFile("dist/Penguincord.user.js", cssRuntime);
});
