...
window.VencordNative = {
    ...
    updater: {
        getRepo: async () => ({ ok: true, value: "https://github.com/penguinrust/Penguincord" }),
    ...
    settings: {
        get: () => {
            try {
                return JSON.parse(localStorage.getItem("PenguincordSettings") || "{}");
            } catch (e) {
                console.error("Failed to parse settings from localStorage: ", e);
                return {};
            }
        },
        set: async (s: Settings) => localStorage.setItem("PenguincordSettings", JSON.stringify(s)),
